...
## 升级命令
```bash
wget -N --no-check-certificate https://raw.githubusercontent.com/314051672/v2ay/master/upgrade.sh && bash upgrade.sh && rm -rf upgrade.sh
```

## 卸载命令
```bash
wget -N --no-check-certificate https://raw.githubusercontent.com/314051672/v2ay/master/uninstall.sh && bash uninstall.sh
```
